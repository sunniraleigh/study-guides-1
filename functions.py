...
def sign_and_parity(num):
    num_sign_parity = ["sign", "parity"]

    if num > 0:
        num_sign_parity[0] = "Positive"
    elif num < 0:
        num_sign_parity[0] = "Negative"
    else:
        num_sign_parity[0] = "Zero"
    
    if num % 2 == 0:
        num_sign_parity[1] = "Even"
    else:
        num_sign_parity[1] = "Odd"
    
    return num_sign_parity

# test = sign_and_parity(3)
# sign = test[0]
# parity = test[1]
...
def write_letter(recipient_name, job_title, sender_name):
    print(f"Dear {full_title(recipient_name, job_title)}, I think you are amazing!",
